...
<Window 
    ...
    Title="L.V.A.S.I. : Installez simplement ... et toujours la dernière version !" Height="550" Width="900" ScrollViewer.VerticalScrollBarVisibility="Disabled" MinWidth="900" MinHeight="550" MaxWidth="900" MaxHeight="550">
 
    <Grid>

    <TextBlock FontSize="14" TextAlignment="Center" HorizontalAlignment="Right" Height="120" Margin="0,10,10,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="210">
    <Bold>--- SÉLECTION ---</Bold>
    </TextBlock>
    
    <Button Name="sebselect" Content="Essentiels" VerticalAlignment="Top" Margin="0,40,66,0" FontSize="14" Height="28" HorizontalAlignment="Right" Width="98" />

    <Button Name="decocher" Content="Tout décocher" VerticalAlignment="Top" Margin="0,80,66,0" FontSize="14" Height="28" HorizontalAlignment="Right" Width="98" />

    <TextBlock FontSize="14" TextAlignment="Center" HorizontalAlignment="Right" Height="120" Margin="0,135,10,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="210">
    <Bold>--- MODE EN LIGNE ---</Bold>
    </TextBlock>

    <Button Name="installer" Content="Installer" ToolTip="Télécharger et installer la sélection" IsEnabled="False" VerticalAlignment="Top" Margin="0,165,66,0" FontSize="14" Height="28" HorizontalAlignment="Right" Width="98" />

    <TextBlock FontSize="14" TextAlignment="Center" HorizontalAlignment="Right" Height="120" Margin="0,195,10,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="210">
    <Bold>------</Bold>
    </TextBlock>

    <Button Name="telecharger" IsEnabled="False" ToolTip ="Télécharger la sélection sans l'installer." Content="Télécharger" VerticalAlignment="Top" Margin="0,220,66,0" FontSize="14" Height="28" HorizontalAlignment="Right" Width="98" />
    
    <TextBlock FontSize="14" TextAlignment="Center" HorizontalAlignment="Right" Height="150" Margin="0,275,10,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="210">
    <Bold>--- MODE HORS LIGNE ---</Bold>
    </TextBlock>

    <Button Name="check" ToolTip='Vérifier le contenu du dossier "LVASI - Téléchargements"' Content="🔁" VerticalAlignment="Top" Margin="0,305,100,0" FontSize="14" Height="28" HorizontalAlignment="Right" Width="28" />

    <Button Name="offinstaller" ToolTip="Installer les logiciels téléchargés précédemment" Content="Installer" IsEnabled="False" VerticalAlignment="Top" Margin="0,345,66,0" FontSize="14" Height="28" HorizontalAlignment="Right" Width="98" />

    <TextBlock FontSize="14" TextAlignment="Center" HorizontalAlignment="Right" Height="200" Margin="0,395,10,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="210">
    <Bold>--- CONTACT ---</Bold>
    <LineBreak />
    <LineBreak />
    ...
    Version 2.4 du 14 août 2022 <Italic>(142 logiciels supportés)</Italic>
    </TextBlock>

    <Grid>
        <TabControl TabStripPlacement="Left" Margin="5,0,220,25" FontSize="14" >
            ...
            <Grid>
                ...
                <CheckBox Name="homebank" Content="HomeBank" HorizontalAlignment="Left" Margin="10,56,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="joplin" Content="Joplin" HorizontalAlignment="Left" Margin="10,79,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="libreoffice" Content="LibreOffice" HorizontalAlignment="Left" Margin="10,102,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="maxicompte" Content="MaxiCompte" HorizontalAlignment="Left" Margin="10,125,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="openoffice" Content="OpenOffice" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="pdfcreator" Content="PDFCreator" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="sigil" Content="Sigil" HorizontalAlignment="Left" Margin="10,194,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="sumatrapdf" Content="SumatraPDF" HorizontalAlignment="Left" Margin="10,217,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="teamworks" Content="TeamWorks" HorizontalAlignment="Left" Margin="10,240,0,0" VerticalAlignment="Top"/>
            </Grid>
            </TabItem>
            ...
            <TabItem Header="Audio" Height="30">
            <Grid>
                ...
                <CheckBox Name="musicbee" Content="MusicBee 3.4.2" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="spotify" Content="Spotify" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="tunein" Content="TuneIn" HorizontalAlignment="Left" Margin="10,194,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="winamp" Content="Winamp" HorizontalAlignment="Left" Margin="10,217,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="youtubemusic" Content="Youtube Music" HorizontalAlignment="Left" Margin="10,240,0,0" VerticalAlignment="Top"/>
            </Grid>
            </TabItem>
            <TabItem Header="Vidéo" Height="30">
            <Grid>
                ...
                <CheckBox Name="kodi" Content="Kodi" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="mpcbe" Content="MediaPlayerClassic-BE" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="mpchc" Content="MediaPlayerClassic-HC" HorizontalAlignment="Left" Margin="10,194,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="mkvtoolnix" Content="MKVToolNix" HorizontalAlignment="Left" Margin="10,217,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="netflix" Content="Netflix 🧰" HorizontalAlignment="Left" Margin="10,240,0,0" VerticalAlignment="Top" ToolTip="Application du Store, peut nécessiter d'installer WinGet (dans l'onglet 'Dev')&#010;Ne peut être qu'installé en 'Mode En ligne'"/>
                <CheckBox Name="obsstudio" Content="OBS Studio" HorizontalAlignment="Left" Margin="10,263,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="openshot" Content="OpenShot" HorizontalAlignment="Left" Margin="10,286,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="plexmediaserver" Content="Plex Media Server" HorizontalAlignment="Left" Margin="10,309,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="primevideo" Content="Prime Vidéo 🧰" HorizontalAlignment="Left" Margin="10,332,0,0" VerticalAlignment="Top" ToolTip="Application du Store, peut nécessiter d'installer WinGet (dans l'onglet 'Dev')&#010;Ne peut être qu'installé en 'Mode En ligne'"/>
                <CheckBox Name="screentogif" Content="ScreenToGif" HorizontalAlignment="Left" Margin="10,355,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="sharex" Content="ShareX" HorizontalAlignment="Left" Margin="10,378,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="shotcut" Content="Shotcut" HorizontalAlignment="Left" Margin="10,401,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="vlc" Content="VLC" HorizontalAlignment="Left" Margin="10,424,0,0" VerticalAlignment="Top"/>
            </Grid>
            </TabItem>
            <TabItem Header="3D" Height="30">
            <Grid>
                <CheckBox Name="tdbuilder" Content="3D Builder 🧰" ToolTip="Application du Store, peut nécessiter d'installer WinGet (dans l'onglet 'Dev')&#010;Ne peut être qu'installé en 'Mode En ligne'" HorizontalAlignment="Left" Margin="10,10,0,0" VerticalAlignment="Top"/>
            ...
            <Grid>
                ...
                <CheckBox Name="winget" Content="WinGet ℹ" ToolTip="Nécessaire pour installer les applications du Store avec LVASI (notées avec 🧰) &#010;Déjà présent dans Windows 11 et les récentes versions de Windows 10" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="winscp" Content="WinSCP" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
            </Grid>
            </TabItem>
            ...
            <Grid>
                ...
                <CheckBox Name="hpsmart" Content="HP Smart 🧰" HorizontalAlignment="Left" Margin="10,79,0,0" VerticalAlignment="Top" ToolTip="Application du Store, peut nécessiter d'installer WinGet (dans l'onglet 'Dev')&#010;Ne peut être qu'installé en 'Mode En ligne'"/>
                ...
                <CheckBox Name="mediainfo" Content="MediaInfo" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="netlimiter" Content="NetLimiter" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="pushbullet" Content="PushBullet" HorizontalAlignment="Left" Margin="10,194,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="qtt" Content="QTTabBar" HorizontalAlignment="Left" Margin="10,217,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="raspberrypi" Content="RaspberryPiImager" HorizontalAlignment="Left" Margin="10,240,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="recuva" Content="Recuva" HorizontalAlignment="Left" Margin="10,263,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="revo" Content="RevoUninstaller" HorizontalAlignment="Left" Margin="10,289,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="speccy" Content="Speccy" HorizontalAlignment="Left" Margin="10,312,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="teamviewer" Content="TeamViewer" HorizontalAlignment="Left" Margin="10,335,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="virtualbox" Content="VirtualBox" HorizontalAlignment="Left" Margin="10,358,0,0" VerticalAlignment="Top"/>
           </Grid>
            </TabItem>
...
$tdbuilder, $netflix, $disney, $hpsmart, $primevideo, $amazonmusic, $tunein).add_click{
...
Start-Process ".\LVASI - Installation\Transmission.msi" -argumentlist "/passive" -wait
...
Start-Process ".\LVASI - Téléchargements\Transmission.msi" -argumentlist "/passive" -wait
