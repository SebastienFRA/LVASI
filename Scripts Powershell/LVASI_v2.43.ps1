...
<Window 
    ...
    Version 2.43 du 27 août 2022 <Italic>(180 logiciels supportés)</Italic>
    </TextBlock>
    ...
    <Grid>
        <TabControl TabStripPlacement="Left" Margin="5,0,210,25" FontSize="14" HorizontalContentAlignment="Left">
            ...
            <Grid>
                ...
                <CheckBox Name="fileoptimizer" Content="FileOptimizer" HorizontalAlignment="Left" Margin="10,79,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="peazip" Content="Peazip" HorizontalAlignment="Left" Margin="10,102,0,0" VerticalAlignment="Top"/>
            </Grid>
            </TabItem>
            ...
            <Grid>
                ...
                <CheckBox Name="gcompris" Content="GCompris" HorizontalAlignment="Left" Margin="10,56,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="geogebra" Content="GeoGebra" HorizontalAlignment="Left" Margin="10,79,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="klavaro" Content="Klavaro" HorizontalAlignment="Left" Margin="10,102,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="openboard" Content="OpenBoard" HorizontalAlignment="Left" Margin="10,125,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="qalculate" Content="Qalculate!" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="stellarium" Content="Stellarium" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
            </Grid>
            </TabItem>
            ...
            <Grid>
                ...
                <CheckBox Name="photofiltre" Content="PhotoFiltre 7 ℹ" HorizontalAlignment="Left" Margin="10,102,0,0" VerticalAlignment="Top" ToolTip="Logiciel sans installation, ne peut être que téléchargé.&#10;Software without installation, can only be downloaded."/>
            ...
            <Grid>
                ...
                <CheckBox Name="openvideodwnder" Content="Open Video Downloader" HorizontalAlignment="Left" Margin="10,309,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="openshot" Content="OpenShot" HorizontalAlignment="Left" Margin="10,332,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="plexmediaserver" Content="Plex Media Server" HorizontalAlignment="Left" Margin="10,355,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="primevideo" Content="Prime Vidéo 🧰" HorizontalAlignment="Left" Margin="10,378,0,0" VerticalAlignment="Top" ToolTip="Application du Store, peut nécessiter d'installer WinGet (dans l'onglet 'Dev')&#010;Ne peut être qu'installé en 'Mode En ligne'&#10;Store app, may need to install WinGet (in 'Dev' tab) Can only be installed in 'Online Mode'"/>
                <CheckBox Name="screentogif" Content="ScreenToGif" HorizontalAlignment="Left" Margin="10,401,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="sharex" Content="ShareX" HorizontalAlignment="Left" Margin="10,424,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="shotcut" Content="Shotcut" HorizontalAlignment="Left" Margin="10,447,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="shutterencoder" Content="Shutter Encoder" HorizontalAlignment="Left" Margin="270,10,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="vlc" Content="VLC" HorizontalAlignment="Left" Margin="270,33,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="vokoscreen" Content="vokoscreenNG" HorizontalAlignment="Left" Margin="270,56,0,0" VerticalAlignment="Top"/>
            </Grid>
            </TabItem>
            ...
            <Grid>
                ...
                <CheckBox Name="expressvpn" Content="ExpressVPN" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="glary" Content="Glary Utilities" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="keepass" Content="KeePass 2.x" HorizontalAlignment="Left" Margin="10,194,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="malwarebytes" Content="Malwarebytes" HorizontalAlignment="Left" Margin="10,217,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="nordvpn" Content="NordVPN" HorizontalAlignment="Left" Margin="10,240,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="spybot" Content="Spybot" HorizontalAlignment="Left" Margin="10,263,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="veracrypt" Content="VeraCrypt" HorizontalAlignment="Left" Margin="10,286,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="wisediskmanager" Content="Wise Disk Manager" HorizontalAlignment="Left" Margin="10,309,0,0" VerticalAlignment="Top"/>
            </Grid>
            </TabItem>
            ...
            <Grid>
                ...
                <CheckBox Name="driverstore" Content="DriverStore Explorer ℹ" HorizontalAlignment="Left" Margin="10,79,0,0" VerticalAlignment="Top" ToolTip="Logiciel sans installation, ne peut être que téléchargé.&#10;Software without installation, can only be downloaded."/>
                <CheckBox Name="everything" Content="Everything" HorizontalAlignment="Left" Margin="10,102,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="flameshot" Content="Flameshot" HorizontalAlignment="Left" Margin="10,125,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="hpsmart" Content="HP Smart 🧰" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top" ToolTip="Application du Store, peut nécessiter d'installer WinGet (dans l'onglet 'Dev')&#010;Ne peut être qu'installé en 'Mode En ligne'&#10;Store app, may need to install WinGet (in 'Dev' tab) Can only be installed in 'Online Mode'"/>
                <CheckBox Name="kdeconnect" Content="KDEConnect" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="mediainfo" Content="MediaInfo" HorizontalAlignment="Left" Margin="10,194,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="netlimiter" Content="NetLimiter" HorizontalAlignment="Left" Margin="10,217,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="parsec" Content="Parsec" HorizontalAlignment="Left" Margin="10,240,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="pushbullet" Content="PushBullet" HorizontalAlignment="Left" Margin="10,263,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="qtranslate" Content="QTranslate" HorizontalAlignment="Left" Margin="10,286,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="qtt" Content="QTTabBar" HorizontalAlignment="Left" Margin="10,309,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="raspberrypi" Content="RaspberryPiImager" HorizontalAlignment="Left" Margin="10,332,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="recuva" Content="Recuva" HorizontalAlignment="Left" Margin="10,355,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="rescuezilla" Content="Rescuezilla ℹ" HorizontalAlignment="Left" Margin="10,378,0,0" VerticalAlignment="Top" ToolTip="Image disque, ne peut être que téléchargé.&#10;Disk image, can only be downloaded."/>
                <CheckBox Name="revo" Content="RevoUninstaller" HorizontalAlignment="Left" Margin="10,401,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="rufus" Content="Rufus ℹ" HorizontalAlignment="Left" Margin="10,424,0,0" VerticalAlignment="Top" ToolTip="Logiciel sans installation, ne peut être que téléchargé.&#10;Software without installation, can only be downloaded."/>
                <CheckBox Name="snappydriver" Content="Snappy Driver Installer Origin ℹ" HorizontalAlignment="Left" Margin="10,447,0,0" VerticalAlignment="Top" ToolTip="Logiciel sans installation, ne peut être que téléchargé.&#10;Software without installation, can only be downloaded."/>
                <CheckBox Name="speccy" Content="Speccy" HorizontalAlignment="Left" Margin="270,10,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="teamviewer" Content="TeamViewer" HorizontalAlignment="Left" Margin="270,33,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="virtualbox" Content="VirtualBox" HorizontalAlignment="Left" Margin="270,56,0,0" VerticalAlignment="Top"/>
           </Grid>
            </TabItem>
            ...
            <Grid>
                <CheckBox Name="contextmm" Content="ContextMenuManager ℹ" HorizontalAlignment="Left" Margin="10,10,0,0" VerticalAlignment="Top" ToolTip="Logiciel sans installation, ne peut être que téléchargé.&#10;Software without installation, can only be downloaded."/>
                <CheckBox Name="copyq" Content="CopyQ" HorizontalAlignment="Left" Margin="10,33,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="files" Content="Files" HorizontalAlignment="Left" Margin="10,56,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="ksnip" Content="Ksnip" HorizontalAlignment="Left" Margin="10,79,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="lightbulb" Content="LightBulb" HorizontalAlignment="Left" Margin="10,102,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="modernflyouts" Content="ModernFlyouts" HorizontalAlignment="Left" Margin="10,125,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="openshell" Content="OpenShell" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="powertoys" Content="PowerToys" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="quicklook" Content="QuickLook" HorizontalAlignment="Left" Margin="10,194,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="rainmeter" Content="Rainmeter" HorizontalAlignment="Left" Margin="10,217,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="teracopy" Content="TeraCopy" HorizontalAlignment="Left" Margin="10,240,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="winaero" Content="WinaeroTweaker" HorizontalAlignment="Left" Margin="10,263,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="wpd" Content="WPD ℹ" HorizontalAlignment="Left" Margin="10,286,0,0" VerticalAlignment="Top" ToolTip="Logiciel sans installation, ne peut être que téléchargé.&#10;Software without installation, can only be downloaded."/>
            </Grid>
            </TabItem>
...
$shutterencoder.ischecked -or $buttercup.ischecked){
...
$circuitjs1, $buttercup, $wpd).add_click{
if ($szip.IsChecked -or $bandizip.IsChecked -or $peazip.IsChecked -or $calibre.IsChecked -or $evernote.IsChecked -or 
$joplin.IsChecked -or $libreoffice.IsChecked -or $maxicompte.IsChecked -or $openoffice.IsChecked -or $pdfcreator.IsChecked -or
$sigil.IsChecked -or $sumatrapdf.IsChecked -or $teamworks.IsChecked -or $gcompris.IsChecked -or $geogebra.IsChecked -or
$bluestacks.IsChecked -or $egs.IsChecked -or $noxplayer.IsChecked -or $origin.IsChecked -or $playnite.IsChecked -or
...
$openvideodwnder.ischecked -or $shutterencoder.ischecked -or $circuitjs1.ischecked -or $buttercup.ischecked -or $wpd.ischecked){
...
$url = ((Invoke-WebRequest -uri "https://github.com/Lymphatus/caesium-image-compressor/releases/latest" -UseBasicParsing).links | Where-Object href -like "*setup.exe").href

Invoke-WebRequest "https://github.com$url" -OutFile ".\LVASI - Installation\Caesium Image Compressor.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'Caesium Image Compressor','Installation terminée',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
$url = ((Invoke-WebRequest -uri "https://github.com/OpenBoard-org/OpenBoard/releases/latest" -UseBasicParsing).links | Where-Object href -like "*Installer*.exe").href

Invoke-WebRequest "https://github.com$url" -OutFile ".\LVASI - Installation\OpenBoard.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'OpenBoard','Installation terminée',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
$url = ((Invoke-WebRequest -uri "https://github.com/jely2002/youtube-dl-gui/releases/latest" -UseBasicParsing).links | Where-Object href -like "*Setup*.exe").href

Invoke-WebRequest "https://github.com$url" -OutFile ".\LVASI - Installation\Open Video Downloader.exe"

Start-Process ".\LVASI - Installation\Open Video Downloader.exe" -argumentlist "/S" -wait

$urlyt = ((Invoke-WebRequest -uri "https://github.com/ytdl-org/youtube-dl/releases/latest" -UseBasicParsing).links | Where-Object href -like "*.exe").href

Invoke-WebRequest "https://github.com$urlyt" -outfile "$env:USERPROFILE\AppData\Local\Programs\youtube-dl-gui\resources\app.asar.unpacked\binaries\yt-dlp.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'Open Video Downloader','Installation terminée',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'Shutter Encoder','Installation terminée',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
$url = ((Invoke-WebRequest -uri "https://github.com/vkohaupt/vokoscreenNG/releases/latest").links | Where-Object href -like "*win64.exe").href

Invoke-WebRequest "https://github.com$url" -OutFile ".\LVASI - Installation\vokoscreenNG.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'vokoscreenNG','Installation terminée',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
$url = ((Invoke-WebRequest -uri "https://github.com/buttercup/buttercup-desktop/releases/latest" -UseBasicParsing).links | Where-Object href -like "*installer.exe").href

Invoke-WebRequest "https://github.com$url" -OutFile ".\LVASI - Installation\Buttercup.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'Buttercup','Installation terminée',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
Invoke-WebRequest "https://github.com$url" -outfile ".\LVASI - Téléchargements\Caesium Image Compressor.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'Caesium Image Compressor','Téléchargement terminé',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'CircuitJS1','Téléchargement terminé',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
Invoke-WebRequest "https://github.com$url" -outfile ".\LVASI - Téléchargements\OpenBoard.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'OpenBoard','Téléchargement terminé',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
Invoke-WebRequest "https://github.com$url" -OutFile ".\LVASI - Téléchargements\Open Video Downloader\Open Video Downloader.exe"

$urlyt = ((Invoke-WebRequest -uri "https://github.com/ytdl-org/youtube-dl/releases/latest" -UseBasicParsing).links | Where-Object href -like "*.exe").href

Invoke-WebRequest "https://github.com$urlyt" -outfile ".\LVASI - Téléchargements\Open Video Downloader\yt-dlp.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'Open Video Downloader','Téléchargement terminé',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'Shutter Encoder','Téléchargement terminé',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
Invoke-WebRequest "https://github.com$url" -OutFile ".\LVASI - Téléchargements\vokoscreenNG.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'vokoscreenNG','Téléchargement terminé',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
Invoke-WebRequest "https://github.com$url" -OutFile ".\LVASI - Téléchargements\Buttercup.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'Buttercup','Téléchargement terminé',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
$url = ((Invoke-WebRequest -uri "https://github.com/lostindark/DriverStoreExplorer/releases/latest" -UseBasicParsing).links | Where-Object href -like "*release*.zip").href

Invoke-WebRequest "https://github.com$url" -OutFile ".\LVASI - Téléchargements\DriverStore Explorer.zip"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'DriverStore Explorer','Téléchargement terminé',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
Invoke-WebRequest "https://github.com$url" -outfile ".\LVASI - Téléchargements\Rescuezilla.iso"
...
$url = ((Invoke-WebRequest -uri "https://github.com/BluePointLilac/ContextMenuManager/releases/latest" -UseBasicParsing).links | Where-Object href -like "*NET.4.0.exe").href

Invoke-WebRequest "https://github.com$url" -outfile ".\LVASI - Téléchargements\ContextMenuManager.exe"
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'ContextMenuManager','Téléchargement terminé',[system.windows.forms.tooltipicon]::Info)
}
#endregion
...
$notify.icon = [System.Drawing.SystemIcons]::Information
$notify.visible = $true
$notify.showballoontip(10000,'WPD','Téléchargement terminé',[system.windows.forms.tooltipicon]::Info)
}
#endregion
#endregion
