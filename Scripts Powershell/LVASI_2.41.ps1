...
<Window 
    ...
    <Button Name="check" ToolTip='Vérifier le contenu du dossier "LVASI - Téléchargements"' Content="🔁" VerticalAlignment="Top" Margin="0,305,100,0" FontSize="18" Height="28" HorizontalAlignment="Right" Width="28" />
    ...
    Version 2.41 du 21 août 2022 <Italic>(148 logiciels supportés)</Italic>
    </TextBlock>
    ...
    <Grid>
        <TabControl TabStripPlacement="Left" Margin="5,0,220,25" FontSize="14" >
            ...
            <Grid>
                ...
                <CheckBox Name="libreoffice" Content="LibreOffice" HorizontalAlignment="Left" Margin="10,125,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="maxicompte" Content="MaxiCompte" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="openoffice" Content="OpenOffice" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="pdfcreator" Content="PDFCreator" HorizontalAlignment="Left" Margin="10,194,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="sigil" Content="Sigil" HorizontalAlignment="Left" Margin="10,217,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="sumatrapdf" Content="SumatraPDF" HorizontalAlignment="Left" Margin="10,240,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="teamworks" Content="TeamWorks" HorizontalAlignment="Left" Margin="10,263,0,0" VerticalAlignment="Top"/>
            </Grid>
            </TabItem>
            ...
            <Grid>
                ...
                <CheckBox Name="musicbee" Content="MusicBee 🧰" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top" ToolTip="Application du Store, peut nécessiter d'installer WinGet (dans l'onglet 'Dev')&#010;Ne peut être qu'installé en 'Mode En ligne'"/>
            ...
            <Grid>
                ...
                <CheckBox Name="iobitdriver" Content="IObit Driver Booster" HorizontalAlignment="Left" Margin="10,125,0,0" VerticalAlignment="Top"/>
                ...
                <CheckBox Name="pushbullet" Content="PushBullet" HorizontalAlignment="Left" Margin="10,217,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="qtt" Content="QTTabBar" HorizontalAlignment="Left" Margin="10,240,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="raspberrypi" Content="RaspberryPiImager" HorizontalAlignment="Left" Margin="10,263,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="recuva" Content="Recuva" HorizontalAlignment="Left" Margin="10,289,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="revo" Content="RevoUninstaller" HorizontalAlignment="Left" Margin="10,312,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="speccy" Content="Speccy" HorizontalAlignment="Left" Margin="10,335,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="teamviewer" Content="TeamViewer" HorizontalAlignment="Left" Margin="10,358,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="virtualbox" Content="VirtualBox" HorizontalAlignment="Left" Margin="10,381,0,0" VerticalAlignment="Top"/>
           </Grid>
            </TabItem>
...
$tdbuilder, $netflix, $disney, $hpsmart, $primevideo, $amazonmusic, $tunein, $xbox, $drawio, $burnaware, $ferdi, $caprine, $messenger).add_click{
...
$screentogif, $vivaldi, $goggalaxy, $winaero, $retroarch, $romstation, $directx, $visualcode, $geforce, $geforcenow, $megasync, $nextcloud,
$owncloud, $synctrayzor, $tweeten, $quicklook, $qalculate, $deezer, $youtubemusic, $slack, $keepass, $deluge, $homebank, $klavaro, $transmission, $winget,
$tunein, $drawio, $burnaware, $ferdi, $caprine, $messenger).add_click{
if ($szip.IsChecked -or $bandizip.IsChecked -or $peazip.IsChecked -or $calibre.IsChecked -or $evernote.IsChecked -or 
$joplin.IsChecked -or $libreoffice.IsChecked -or $maxicompte.IsChecked -or $openoffice.IsChecked -or $pdfcreator.IsChecked -or
$sigil.IsChecked -or $sumatrapdf.IsChecked -or $teamworks.IsChecked -or $gcompris.IsChecked -or $geogebra.IsChecked -or
$bluestacks.IsChecked -or $egs.IsChecked -or $noxplayer.IsChecked -or $origin.IsChecked -or $playnite.IsChecked -or
...
$tweeten.ischecked -or $quicklook.ischecked -or $qalculate.ischecked -or $deezer.ischecked -or $youtubemusic.ischecked -or $slack.ischecked -or
$keepass.ischecked -or $deluge.isChecked -or $homebank.ischecked -or $klavaro.ischecked -or $transmission.ischecked -or $winget.ischecked -or
$tunein.ischecked -or $drawio.ischecked - $burnaware.ischecked -or $ferdi.ischecked -or $caprine.ischecked -or $messenger.ischecked){
...
$caprine.ischecked = $false ; $messenger.ischecked = $false ;
