...
<Window 
    ...
    Version 2.2 du 22 juillet 2022 <Italic>(118 logiciels supportés)</Italic>
    </TextBlock>
    ...
    <Grid>
        <TabControl TabStripPlacement="Left" Margin="5,0,230,25" FontSize="14" >
            ...
            <Grid>
                ...
                <CheckBox Name="goggalaxy" Content="GOG Galaxy" HorizontalAlignment="Left" Margin="10,79,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="noxplayer" Content="NoxPlayer" HorizontalAlignment="Left" Margin="10,102,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="origin" Content="Origin" HorizontalAlignment="Left" Margin="10,125,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="playnite" Content="PlayNite" HorizontalAlignment="Left" Margin="10,148,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="retroarch" Content="RetroArch" HorizontalAlignment="Left" Margin="10,171,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="romstation" Content="RomStation" HorizontalAlignment="Left" Margin="10,194,0,0" VerticalAlignment="Top"/>
                <CheckBox Name="steam" Content="Steam" HorizontalAlignment="Left" Margin="10,217,0,0" VerticalAlignment="Top"/>
            </Grid>
            </TabItem>
...
$screentogif, $vivaldi, $goggalaxy, $winaero, $retroarch, $romstation, $directx, $visualcode, $geforce).add_click{
...
$visualcode.ischecked = $false ; $geforce.ischecked = $false
