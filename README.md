...
- Dézipez tout d'abord le fichier dans le dossier de votre choix.

- Pour que le script principal prenne en compte l'installation d'un
...
- Lorsque les scripts des logiciels choisis sont tous mis dans le même
...
- Une fenêtre Powershell s'ouvre alors et des instructions sont affichées
...
- Une fois les vaidations effectuées, le script procédera aux téléchargements
...
- Lorsque tout sera terminé, les fichiers téléchargés auront été supprimés,
